...
export default function AboutPage() {
  ...
  return (
    ...
    <PageLayout title={"About Us"} imgUrl={"/common/about-cover.jpeg"}>
      ...
      <div className='px-4 sm:px-0 flex justify-center items-center py-10 md:py-16'>
        {/* The white card container */}
        <div data-aos="fade-down" className='p-8 bg-background sm:p-12 md:w-4/5 lg:w-3/4 xl:w-3/5 ShadowLarge'>
          {/* Header section */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="text-center p-4">
              {/* MODIFIED: Changed bg-blue-500 to bg-secondary */}
            ...
            {/* Collaborate Pillar */}
            <div className="text-center p-4">
              {/* MODIFIED: Changed bg-green-500 to bg-primary */}
